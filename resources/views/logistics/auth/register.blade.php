@extends('layouts.auth-split', [
    'title' => 'Storkia - Logistics Hub Registration',
    'mobilePrompt' => 'You are trying to register a Logistics Account. Please access this page from a computer to continue.'
])

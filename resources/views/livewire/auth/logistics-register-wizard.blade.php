    ...
    @if ($registrationSuccessful)
        <div class="text-center py-10 animate-fade-in-up">
            ...
            <p class="text-text-muted text-sm max-w-md mx-auto mb-8 leading-relaxed font-normal">
                Thank you for applying to be a logistics sorting center. Your documents and hub location are under review. Updates will be sent to <span class="font-semibold text-text-main">{{ $email }}</span>.
            </p>
    ...
    @else
        ...
        <div class="mb-8 text-center">
            ...
            <p class="mt-2 text-sm text-text-muted font-normal leading-relaxed">
                @if ($currentStep === 1) Verify your email to begin sorting center registration
                @elseif ($currentStep === 2) Personal details of the hub manager
                @elseif ($currentStep === 3) Contact number and hub facility address
                @elseif ($currentStep === 4) Sorting center or logistics hub designation
                @elseif ($currentStep === 5) Facility and identity verification documents
                @elseif ($currentStep === 6) Set up your hub operational credentials
                @elseif ($currentStep === 7) Review and submit your logistics application
                @endif
            </p>
        </div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative border-b border-border-subtle focus-within:border-text-main transition-colors">
                        <input type="text" wire:model="street" class="w-full py-2.5 bg-transparent text-text-main text-base outline-none placeholder:text-text-muted/40" placeholder="e.g. Industrial Ave">
                    </div>
                </div>

                <div>
                    <label class="block text-xs uppercase tracking-wider font-bold text-text-muted mb-1.5">House / Building / Unit Details</label>
                    <div class="relative border-b border-border-subtle focus-within:border-text-main transition-colors">
                        <input type="text" wire:model="house_details" class="w-full py-2.5 bg-transparent text-text-main text-base outline-none placeholder:text-text-muted/40" placeholder="e.g. Warehouse 3, Logistics Park">
                    </div>
                </div>
        ...
        @if ($currentStep === 4)
            <div class="space-y-6">
                <div>
                    <label class="block text-xs uppercase tracking-wider font-bold text-text-muted mb-1.5">Sorting Center / Hub Name*</label>
                    <div class="relative border-b {{ $errors->has('business_name') ? 'border-danger' : 'border-border-subtle focus-within:border-text-main' }} transition-colors">
                        <input 
                            ...
                            class="w-full py-2.5 bg-transparent text-text-main text-base outline-none placeholder:text-text-muted/40" 
                            placeholder="e.g. Cavite Central Sorting Center"
                        >
                    </div>
        ...
        @if ($currentStep === 5)
            <div class="space-y-6">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1.5">
                        <label class="block text-xs uppercase tracking-wider font-bold text-text-muted">Hub / Business Permit*</label>
                        <span class="text-[11px] text-text-muted">JPG, PNG, PDF (Max 10MB)</span>
                    </div>
        ...
        @if ($currentStep === 7)
            <div class="space-y-6 text-xs">
                <div class="space-y-5">
                    ...
                    <div class="border-b border-border-subtle/70 pb-3">
                        <div class="flex justify-between items-center mb-2">
                            <span class="uppercase tracking-wider font-bold text-primary-dark">Hub Facility Location</span>
                    ...
                    <div class="border-b border-border-subtle/70 pb-3">
                        <div class="flex justify-between items-center mb-2">
                            <span class="uppercase tracking-wider font-bold text-primary-dark">Facility Details</span>
                        ...
                        <div class="space-y-1 text-text-muted">
                            <p><span class="text-text-main font-semibold">Center Name:</span> {{ $business_name }}</p>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-border-subtle/70 pb-3">
                        ...
                        <div class="space-y-1 text-text-muted">
                            ...
                            <p><span class="text-text-main font-semibold">Hub Permit:</span> {{ $business_permit ? $business_permit->getClientOriginalName() : 'Attached' }}</p>
                        </div>
                    </div>
                </div>
